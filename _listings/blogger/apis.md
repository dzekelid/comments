...
- name: Blogger API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/comments/master/_listings/blogger/blogs-blogid-posts-postid-comments-commentid-removecontent-post.md
x-common:
- type: x-blog
