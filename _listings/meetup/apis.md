...
- name: Meetup Event Comment and Reply Likes
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/comments/master/_listings/meetup/urlname-events-event-id-comments-comment-id-likes-get.md
x-common:
- type: x-base
