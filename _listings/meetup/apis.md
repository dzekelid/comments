...
- name: Meetup Photo Comment
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/comments/master/_listings/meetup/urlname-events-event-id-photos-photo-id-comments-post.md
x-common:
- type: x-base
