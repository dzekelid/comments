...
- name: Meetup Event Comment Unlike
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/comments/master/_listings/meetup/urlname-events-event-id-comments-comment-id-likes-delete.md
x-common:
- type: x-base
