...
- name: Bitbucket
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/comments/master/_listings/bitbucket/repositories-username-repo-slug-pullrequests-pull-request-id-comments-comment-id-get.md
x-common:
- type: x-developer
