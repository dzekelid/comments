...
- name: Bitbucket Get Repositories Username Repo Slug Issues Issue  Comments Comment
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/comments/master/_listings/bitbucket/repositories-username-repo-slug-issues-issue-id-comments-comment-id-get.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/comments/master/_listings/bitbucket/repositories-username-repo-slug-issues-issue-id-comments-comment-id-get-postman.md
x-common:
- type: x-developer
