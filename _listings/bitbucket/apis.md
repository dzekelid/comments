...
- name: Bitbucket Parameters Snippets Username Encoded  Comments Comment
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/comments/master/_listings/bitbucket/snippets-username-encoded-id-comments-comment-id-parameters.md
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/comments/master/_listings/bitbucket/snippets-username-encoded-id-comments-comment-id-parameters-postman.md
x-common:
- type: x-developer
